_os()
{
  ...
  # Command data:
  cmds='access address aggregate application availability baremetal bgp bgpvpn catalog command complete compute configuration consistency console consumer container credential dns domain ec2 endpoint extension federation firewall flavor floating group help host hypervisor identity image implied ip keypair limit limits mapping module network object policy port project ptr quota recordset region registered request role router security server service sfc subnet tld token trust tsigkey usage user versions volume vpn zone'
  cmds_access='token'
  ...
  cmds_application_credential_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --secret --role --expiration --description --unrestricted --restricted'
  ...
  cmds_baremetal_allocation_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --resource-class --trait --candidate-node --name --uuid --extra --wait --node'
  cmds_baremetal_allocation_delete='-h --help'
  cmds_baremetal_allocation_list='-h --help -f --format -c --column --quote --noindent --max-width --fit-width --print-empty --sort-column --limit --marker --sort --node --resource-class --state --long --fields'
  ...
  cmds_baremetal_node_list='-h --help -f --format -c --column --quote --noindent --max-width --fit-width --print-empty --sort-column --limit --marker --sort --maintenance --no-maintenance --fault --associated --unassociated --provision-state --driver --resource-class --conductor-group --conductor --chassis --owner --description-contains --long --fields'
  ...
  cmds_baremetal_node_set='-h --help --instance-uuid --name --chassis-uuid --driver --bios-interface --reset-bios-interface --boot-interface --reset-boot-interface --console-interface --reset-console-interface --deploy-interface --reset-deploy-interface --inspect-interface --reset-inspect-interface --management-interface --reset-management-interface --network-interface --reset-network-interface --power-interface --reset-power-interface --raid-interface --reset-raid-interface --rescue-interface --reset-rescue-interface --storage-interface --reset-storage-interface --vendor-interface --reset-vendor-interface --reset-interfaces --resource-class --conductor-group --automated-clean --protected --protected-reason --target-raid-config --property --extra --driver-info --instance-info --owner --description'
  ...
  cmds_baremetal_node_vif_attach='-h --help --vif-info'
  ...
  cmds_firewall_group_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --name --description --ingress-firewall-policy --no-ingress-firewall-policy --egress-firewall-policy --no-egress-firewall-policy --public --private --share --no-share --enable --disable --project --project-domain --port --no-port'
  ...
  cmds_firewall_group_policy_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --description --audited --no-audited --share --public --private --no-share --project --project-domain --firewall-rule --no-firewall-rule'
  ...
  cmds_firewall_group_policy_set='-h --help --description --audited --no-audited --share --public --private --no-share --name --firewall-rule --no-firewall-rule'
  cmds_firewall_group_policy_show='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty'
  cmds_firewall_group_policy_unset='-h --help --firewall-rule --all-firewall-rule --audited --share --public'
  ...
  cmds_firewall_group_rule_unset='-h --help --source-ip-address --destination-ip-address --source-port --destination-port --share --public --enable-rule --source-firewall-group --destination-firewall-group'
  cmds_firewall_group_set='-h --help --name --description --ingress-firewall-policy --no-ingress-firewall-policy --egress-firewall-policy --no-egress-firewall-policy --public --private --share --no-share --enable --disable --port --no-port'
  cmds_firewall_group_show='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty'
  cmds_firewall_group_unset='-h --help --port --all-port --ingress-firewall-policy --egress-firewall-policy --public --share --enable'
  ...
  cmds_floating_ip_set='-h --help --port --fixed-ip-address --qos-policy --no-qos-policy --tag --no-tag'
  ...
  cmds_project_list='-h --help -f --format -c --column --quote --noindent --max-width --fit-width --print-empty --sort-column --domain --user --my-projects --long --sort --tags --tags-any --not-tags --not-tags-any'
  ...
  cmds_role_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --domain --or-show'
  ...
  cmds_role_set='-h --help --domain --name'
  ...
  cmds_security_group_rule_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --remote-ip --remote-group --description --dst-port --icmp-type --icmp-code --protocol --proto --ingress --egress --ethertype --project --project-domain'
  ...
  cmds_server='add backup create delete dump event group image list lock migrate pause reboot rebuild remove rescue resize resize_confirm resize_revert restore resume set shelve show ssh start stop suspend unlock unpause unrescue unset unshelve'
  ...
  cmds_subnet_set='-h --help --name --dhcp --no-dhcp --gateway --network-segment --description --tag --no-tag --allocation-pool --no-allocation-pool --dns-nameserver --no-dns-nameservers --host-route --no-host-route --service-type'

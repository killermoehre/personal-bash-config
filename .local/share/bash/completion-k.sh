...
# bash completion for k                              -*- shell-script -*-
...
# call k get $1,
__k_override_flag_list=(kubeconfig cluster user context namespace server)
__k_override_flags()
{
    local ${__k_override_flag_list[*]} two_word_of of
    for w in "${words[@]}"; do
...
__k_config_get_contexts()
{
    __k_parse_config "contexts"
}

__k_config_get_clusters()
{
    __k_parse_config "clusters"
}

__k_config_get_users()
{
    __k_parse_config "users"
}

# $1 has to be "contexts", "clusters" or "users"
__k_parse_config()
{
    local template k_out
    template="{{ range .$1  }}{{ .name }} {{ end }}"
    if k_out=$(k config $(__k_override_flags) -o template --template="${template}" view 2>/dev/null); then
...
__k_parse_get()
{
    ...
    local k_out
    if k_out=$(k get $(__k_override_flags) -o template --template="${template}" "$1" 2>/dev/null); then
        COMPREPLY=( $( compgen -W "${k_out[*]}" -- "$cur" ) )
    fi
}
...
__k_get_containers()
{
    ...
    local k_out
    if k_out=$(k get $(__k_override_flags) -o template --template="${template}" pods "${last}" 2>/dev/null); then
        COMPREPLY=( $( compgen -W "${k_out[*]}" -- "$cur" ) )
    fi
}

# Require both a pod and a container to be specified
__k_require_pod_and_container()
{
    if [[ ${#nouns[@]} -eq 0 ]]; then
        __k_parse_get pods
        return 0
...
__custom_func() {
    case ${last_command} in
        k_get | k_describe | k_delete | k_label | k_edit | k_patch |\
        k_annotate | k_expose | k_scale | k_autoscale | k_taint | k_rollout_*)
            __k_get_resource
            return
            ;;
        k_logs | k_attach)
            ...
            return
            ;;
        k_exec | k_port-forward | k_top_pod)
            __k_get_resource_pod
            return
            ;;
        k_rolling-update)
            ...
            return
            ;;
        k_cordon | k_uncordon | k_drain | k_top_node)
            __k_get_resource_node
            return
            ;;
        k_config_use-context)
            __k_config_get_contexts
            return
            ;;
        k_config_delete-cluster)
            __k_config_get_clusters
            return
            ;;
        *)
...
_k_apply_edit-last-applied()
{
    last_command="k_apply_edit-last-applied"
    commands=()
...
_k_apply_set-last-applied()
{
    last_command="k_apply_set-last-applied"
    commands=()
...
_k_apply_view-last-applied()
{
    last_command="k_apply_view-last-applied"
    commands=()
...
_k_certificate_approve()
{
    last_command="k_certificate_approve"
    commands=()
...
_k_certificate_deny()
{
    last_command="k_certificate_deny"
    commands=()
...
_k_cluster-info_dump()
{
    last_command="k_cluster-info_dump"
    commands=()
...
_k_config_current-context()
{
    last_command="k_config_current-context"
    commands=()
...
_k_config_delete-cluster()
{
    last_command="k_config_delete-cluster"
    commands=()
...
_k_config_delete-context()
{
    last_command="k_config_delete-context"
    commands=()
...
_k_config_get-clusters()
{
    last_command="k_config_get-clusters"
    commands=()
...
_k_config_get-contexts()
{
    last_command="k_config_get-contexts"
    commands=()
...
_k_config_rename-context()
{
    last_command="k_config_rename-context"
    commands=()
...
_k_config_set-cluster()
{
    last_command="k_config_set-cluster"
    commands=()
...
_k_config_set-context()
{
    last_command="k_config_set-context"
    commands=()
...
_k_config_set-credentials()
{
    last_command="k_config_set-credentials"
    commands=()
...
_k_config_use-context()
{
    last_command="k_config_use-context"
    commands=()
...
_k_create_clusterrole()
{
    last_command="k_create_clusterrole"
    commands=()
...
_k_create_clusterrolebinding()
{
    last_command="k_create_clusterrolebinding"
    commands=()
...
_k_create_configmap()
{
    last_command="k_create_configmap"
    commands=()
...
_k_create_deployment()
{
    last_command="k_create_deployment"
    commands=()
...
_k_create_namespace()
{
    last_command="k_create_namespace"
    commands=()
...
_k_create_poddisruptionbudget()
{
    last_command="k_create_poddisruptionbudget"
    commands=()
...
_k_create_rolebinding()
{
    last_command="k_create_rolebinding"
    commands=()
...
_k_create_secret_docker-registry()
{
    last_command="k_create_secret_docker-registry"
    commands=()
...
_k_create_secret_generic()
{
    last_command="k_create_secret_generic"
    commands=()
...
_k_create_secret_tls()
{
    last_command="k_create_secret_tls"
    commands=()
...
_k_create_service_clusterip()
{
    last_command="k_create_service_clusterip"
    commands=()
...
_k_create_service_externalname()
{
    last_command="k_create_service_externalname"
    commands=()
...
_k_create_service_loadbalancer()
{
    last_command="k_create_service_loadbalancer"
    commands=()
...
_k_create_service_nodeport()
{
    last_command="k_create_service_nodeport"
    commands=()
...
_k_create_serviceaccount()
{
    last_command="k_create_serviceaccount"
    commands=()
...
_k_rollout_history()
{
    last_command="k_rollout_history"
    commands=()
...
_k_set_serviceaccount()
{
    last_command="k_set_serviceaccount"
    commands=()
...
if [[ $(type -t compopt) = "builtin" ]]; then
    ...
    complete -o default -o nospace -F __start_k k
fi
